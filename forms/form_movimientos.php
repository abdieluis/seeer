...
?>
			          ...
			          <tbody>
			            ...
			            for($i = 0; $i < count($datos); $i++){
			              echo '<tr>
			                  ...
			                  <td class="resultados"> <div class="operacionesTd"> <a class="opcTd" href="#" onclick="abrirPopupConfirmarEliminacion('.$datos[$i]["idSolicitud"].')"><i class="bx bxs-trash"></i></a> <a href="#" onclick="abrirPopupEditarDatosSolicitud('.$datos[$i]["idSolicitud"].')"><i class="bx bx-pencil"></i></a> </div> </td>
			          ...
			          <tbody>
			            ...
			            for($i = 0; $i < count($datos); $i++){
			              echo '<tr>
			                  ...
			                  <td class="resultados"> <div class="operacionesTd"> <a class="opcTd" href="#" onclick="abrirPopupRegistroMovimientoSolicitante('.$datos[$i]["idAudiencia"].')"><i class="bx bxs-trash"></i></a> <a href="#" onclick="abrirPopupRegistroMovimientoSolicitante('.$datos[$i]["idAudiencia"].')"><i class="bx bx-pencil"></i></a> </div> </td>
			...
			<div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
				<center> <h1> <i class='bx bxs-dollar-circle'></i> Ratificaciones</h1> </center>
				<div class="table-responsive tablaResultados">
			        <table id="movimientoRatificaciones" class="table table-striped" style="width:100%">
			          <thead>
			              <tr>
			                  <th class="encabezados">Fecha Solicitud</th>
			                  <th class="encabezados">Nombre Solicitante</th>
			          ...
			          <tbody>
			            ...
			            for($i = 0; $i < count($datos); $i++){
			              echo '<tr>
			                  ...
			                  echo '<td class="resultados"> <div class="operacionesTd"> <a class="opcTd" href="#" onclick="abrirPopupRegistroMovimientoSolicitante('.$datos[$i]["idSolicitud"].')"><i class="bx bxs-trash"></i></a> <a href="#" onclick="abrirPopupRegistroMovimientoSolicitante('.$datos[$i]["idSolicitud"].')"><i class="bx bx-pencil"></i></a> </div> </td>
