...
$resultadoMostrarRatificacionesSinAsignar = obtenerRatificacionesSinAsignar($dbConnect);

  // MOSTRAR LOS DATOS EN UN OBJETO RESPUESTA
if(!empty($resultadoMostrarRatificacionesSinAsignar)){

    $objetoRespuesta['ratificaciones'] = $resultadoMostrarRatificacionesSinAsignar;
