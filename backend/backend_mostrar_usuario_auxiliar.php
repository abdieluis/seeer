...
$resultadoMostrarUsuarioAuxiliar = obtenerUsuariosAuxiliares($dbConnect, 'idCiudad', $idCiudad);

  // MOSTRAR LOS DATOS EN UN OBJETO RESPUESTA
if(!empty($resultadoMostrarUsuarioAuxiliar)){

    $objetoRespuesta['usuario_auxiliar'] = $resultadoMostrarUsuarioAuxiliar;

    $codigo = "fallo";
} else {
    $mensaje = "No hay auxiliares";
    $objetoRespuesta = "";
}
    // =============================================================================================================================================================
