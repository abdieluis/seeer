...
if(!isset($backendIncluido)){
  ...
  $resultadoMostrarDatosSolicitanteMovimiento = obtenerDatosUsuarioSolicitanteSeleccionado($dbConnect, 'idUsuarioSolicitante', $idUsuarioSolicitante);

  // MOSTRAR LOS DATOS EN UN OBJETO RESPUESTA
  if(!empty($resultadoMostrarDatosSolicitanteMovimiento)){

    $objetoRespuesta['solicitante'] = $resultadoMostrarDatosSolicitanteMovimiento;
